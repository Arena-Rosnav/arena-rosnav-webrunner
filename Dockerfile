...
RUN apt-get -y update && apt install -y python3 python-is-python3 git python3-rosdep python3-pip python3-rosinstall python3-rosinstall-generator python3-wstool build-essential libopencv-dev liblua5.2-dev libarmadillo-dev ros-noetic-nlopt liblcm-dev libsdl2-dev
